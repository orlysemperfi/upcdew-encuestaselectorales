<%-- 
    Document   : menuAdmin
    Created on : 13/06/2010, 09:56:40 AM
    Author     : cramirez
--%>
...
<table width="200"  border="2" cellpadding="0" cellspacing="0" class="tabla1">
      <tr>
        <td width="205" scope="col" align="center"  class="td5"><div align="left">
                <img src="images/OpConfEncuesta.jpg" width="200" height="19" /></div></td>
      </tr>
      <tr>
        <td><img src="images/icono.jpg" width="13" height="15" /><a href="configuracion.do?methodToCall=iniciar" class="enlaces" onclick="f_fotos1();">Registo de Encuesta</a><br />
